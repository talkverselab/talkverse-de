...
## 런처 아이콘
- `assets/icon/icon.png`·`icon_foreground.png` — 언어 상징 글자 `ß` + 국기 팔레트(PIL 생성). 17개 talkverse 앱 모두 다른 모양이어야 한다는 규칙.
