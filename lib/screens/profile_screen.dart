      ...
      body: ListView(
        ...
        children: [
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.public, title: tr('변종'), subtitle: tr('표준 독일어 (Deutschland) · Hochdeutsch')),
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.copyright, title: tr('저작권'), subtitle: tr('독일어유니버스 · 2026')),
          ]),
