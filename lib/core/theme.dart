...
class AppColors {
  // 主色 — Rojo (국기 빨강)
  static const Color rojo = Color(0xFFDD0000);
  static const Color rojoDeep = Color(0xFFA30000);
  static const Color rojoLight = Color(0xFFF04A3E);

  // 副色 — Gualda (국기 노랑/금)
  static const Color gualda = Color(0xFFFFCE00);
  static const Color gualdaBright = Color(0xFFFFE05C);
  static const Color gualdaDeep = Color(0xFFBD9900);
